"""
Extra per-bar signal-quality indicators for the entry-filter study: RSI(14),
ADX(14) (Wilder's method for both), rolling relative volume, cloud
separation (as % of price), and minutes-since-session-open.

All return lists aligned 1:1 with the input bars; early entries that don't
have enough history are None.
"""
